...
import com.app.web.servicios.EstudianteServicio;
...
public class EstudianteControlador {
    ...
    public String actualizarEstudiante (@PathVariable Long id, @ModelAttribute
            ("estudiante") Estudiante estudiante, Model modelo){
